...
Reads JSON files from landing/ directory and converts them to Parquet format
"""
...
class BronzeLayerProcessor:
    ...
    def process_all_data(self, landing_dir: str = "landing") -> None:
        ...
        if not json_files:
            logger.warning("No JSON files found in landing directory")
            return
...
def main():
    """Main function to run bronze layer processing"""
